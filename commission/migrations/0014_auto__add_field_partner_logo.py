...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partner.logo'
        db.add_column(u'commission_partner', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partner.weight'
        db.add_column(u'commission_partner', 'weight',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partner.logo'
        db.delete_column(u'commission_partner', 'logo')

        # Deleting field 'Partner.weight'
        db.delete_column(u'commission_partner', 'weight')
