...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partner.website_display'
        db.add_column(u'commission_partner', 'website_display',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partner.website_display'
        db.delete_column(u'commission_partner', 'website_display')
