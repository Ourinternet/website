...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaContact.display_on_contact'
        db.add_column(u'commission_mediacontact', 'display_on_contact',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'MediaContact.weight'
        db.add_column(u'commission_mediacontact', 'weight',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaContact.display_on_contact'
        db.delete_column(u'commission_mediacontact', 'display_on_contact')

        # Deleting field 'MediaContact.weight'
        db.delete_column(u'commission_mediacontact', 'weight')
