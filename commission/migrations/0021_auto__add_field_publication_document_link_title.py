...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publication.document_link_title'
        db.add_column(u'commission_publication', 'document_link_title',
                      self.gf('django.db.models.fields.CharField')(default='Download PDF', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Publication.document_link_title'
        db.delete_column(u'commission_publication', 'document_link_title')
